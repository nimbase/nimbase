...
## ```
##
## When compiled with `--app:lib -d:nimbaseBuild`, wrapper files are generated
...
macro genCHeader*(exports: varargs[typed]) =
  ...
  ##
  ## Only runs when `-d:nimbaseBuild` is defined.
  ##
  ## ```nim
  ...
  let apiMacro = if modName.len > 0: modName.toUpper & "_API" else: "NIMBASE_API"
  ...
  let full = "/* Auto-generated by Nimbase. Do not edit. */\n\n" &
    "#ifndef " & guardVal & "\n#define " & guardVal & "\n\n" &
    includesBlock &
...
macro genGoHeader*(exports: varargs[typed]) =
  ...
  ## ```
  result = newStmtList()
  when not defined(nimbaseBuild): return
  ...
  let header = "// Auto-generated by Nimbase. Do not edit.\n\n" &
    "package " & pkgName & "\n\n" &
    "/*\n#include \"" & cHeaderRel & "\"\n*/\n" &
    "import \"C\"\n" &
    "import \"unsafe\"\n\n" &
...
macro genNimHeader*(exports: varargs[typed]) =
  ...
  let hdr = "## Low-level C-style Nim bindings for " & modName & ".\n" &
    "##\n" &
    "## Auto-generated by Nimbase. Do not edit.\n\n"
